...
def initialize_parameters(n_x, n_h, n_y):
    ...
    Returns:
    params -- python dictionary containing your paramters:
...
def predict(parameters, X):
    ...
    Arguments:
    Paramters -- python dictionary containing your parameters
    X -- input data of size (n_x, m)
...
if __name__ == "__main__":
    ...
    # try another hidden units number
