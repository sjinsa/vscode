...
def linear_backward(dZ, cache):
    ...
    Returns:
    dA_prev -- Gradient of the cost with respect to the activation (of the preivous layer l-1), same shape as A_prev
...
def linear_activation_backward(dA, cache, activation):
    '''
    Implement the backward propagation for the LINEAR->CATIVATION layer
...
def L_model_backward(AL, Y, caches):
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward(grads["dA" + str(l+2)], cache = current_cache, activation = "relu") 
...
def update_parameters(parameters, grads, learning_rate):
    ...
    Returns:
    parameters -- python dicitonary containing your updated parameters
                  parameters["W" + str(l)] = ...
                  parameters["b" + str(l)] = ...
    '''
